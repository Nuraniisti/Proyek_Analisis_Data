...
product_sales = df_filtered.merge(products[['product_id', 'product_category']], on='product_id')
...
fig, ax = plt.subplots(figsize=(10, 6))
sns.barplot(data=top_categories, x='order_item_id', y='product_category', palette='viridis', ax=ax)
